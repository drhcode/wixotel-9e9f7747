            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <Button 
                  ...
                  onClick={() => window.open('https://wa.me/447400754801?text=Hello!%20I%27m%20interested%20in%20scheduling%20a%20demo%20of%20Wixotel.%20Could%20you%20please%20provide%20more%20information%20about%20your%20hotel%20management%20platform%3F', '_blank')}
                >
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={() => window.open('https://wa.me/447400754801?text=Hello!%20I%20need%20support%20with%20Wixotel.', '_blank')}
                  className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-all hover:translate-x-1 duration-200"
                >
